...
## @type: DataSource
## @args: [database = "reinvent19", table_name = "yellow", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "reinvent19", table_name = "yellow", transformation_ctx = "datasource0")
## @type: ApplyMapping
