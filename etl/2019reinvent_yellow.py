...
datasource0 = glueContext.create_dynamic_frame.from_options(connection_type="s3", connection_options = {"paths": ["s3://serverless-analytics/reinvent-2019/taxi_data/yellow/"]},  format="csv", transformation_ctx = "datasource0")
