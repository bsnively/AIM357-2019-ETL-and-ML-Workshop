...
datasource0 = glueContext.create_dynamic_frame.from_options(connection_type="s3", connection_options = {"paths": ["s3://serverless-analytics/reinvent-2019/taxi_data/fhv/"]},  format="csv", transformation_ctx = "datasource0")
...
applymapping1 = ApplyMapping.apply(frame = datasource0, mappings = [("pickup_datetime", "string", "pickup_datetime", "timestamp"), ("dropoff_datetime", "string", "dropoff_datetime", "timestamp"), ("pulocationid", "long", "pulocationid", "long"), ("dolocationid", "long", "dolocationid", "long")], transformation_ctx = "applymapping1")
## @type: ResolveChoice
